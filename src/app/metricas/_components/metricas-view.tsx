                ...
                {data.proyectos.map((p) => (
                  <Link key={p.id} href={`/proyectos/${p.id}`} className="block">
                    <div className="rounded-lg border bg-card p-4 hover:bg-accent/50 transition-colors">
                      ...
                      <p className="mt-1 font-medium truncate">{p.nombre}</p>
                      <div className="mt-2 grid grid-cols-3 gap-2 text-xs">
                        ...
                        <div>
                          ...
                          <span className="text-violet-400 block">{pct(p.montoFacturado, p.montoTotal)}</span>
                        </div>
                        <div>
                          ...
                          <span className="text-emerald-400 block">{pct(p.montoCobrado, p.montoFacturado)}</span>
                        </div>
                      </div>
                    </div>
                  </Link>
